...
public class ScientificCalculator {
	...
	private void initialize() {
		...
		lblScientificCalculator.setForeground(new Color(69, 0, 0));
		lblScientificCalculator.setFont(new Font("SansSerif", Font.BOLD, 20));
		lblScientificCalculator.setBounds(10, 20, 357, 47);
		...
		btnRoot.setFont(new Font("SansSerif", Font.PLAIN, 16));
		...
		btnRev.setFont(new Font("SansSerif", Font.PLAIN, 15));
		...
		btnFact.setFont(new Font("SansSerif", Font.PLAIN, 21));
		...
		btnPM.setFont(new Font("SansSerif", Font.PLAIN, 14));
		...
		btn7.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn4.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn1.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btnSin.setFont(new Font("SansSerif", Font.PLAIN, 18));
		...
		btn8.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn5.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn2.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn0.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn9.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn6.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btn3.setFont(new Font("SansSerif", Font.BOLD, 22));
		btn3.setBounds(190, 396, 60, 51);
		frame.getContentPane().add(btn3);
		
		JButton btnDot = new JButton(".");
		btnDot.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btnEqual.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		btnSum.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		btnMinus.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		btnMpy.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		btnDivide.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		btnPow.setFont(new Font("SansSerif", Font.PLAIN, 14));
		...
		btnMod.setFont(new Font("SansSerif", Font.BOLD, 20));
		...
		btnC.setFont(new Font("SansSerif", Font.BOLD, 22));
		...
		btnCube.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		btnSqr.setFont(new Font("SansSerif", Font.PLAIN, 15));
		...
		btnCos.setFont(new Font("SansSerif", Font.PLAIN, 18));
		...
		btnTan.setFont(new Font("SansSerif", Font.PLAIN, 18));
		...
		btnTanh.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		btnCosh.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		btnSinh.setFont(new Font("SansSerif", Font.PLAIN, 14));
		...
		btnLog.setFont(new Font("SansSerif", Font.PLAIN, 14));
		...
		btnE.setFont(new Font("SansSerif", Font.PLAIN, 15));
		...
		rdbtnOn.setFont(new Font("SansSerif", Font.PLAIN, 14));
		...
		rdbtnOff.setFont(new Font("SansSerif", Font.PLAIN, 14));
